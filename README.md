...
Dữ liệu thô được lấy từ đây: [link](http://www.nber.org/data/linked-birth-infant-death-data-vital-statistics-data.html)         
...
Hướng dẫn về tập dữ liệu có tại đây: [link](http://www.nber.org/lbid/docs/LinkCO89Guide.pdf)                         
